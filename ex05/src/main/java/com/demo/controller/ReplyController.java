...
public class ReplyController {
	/*
	 ...
	 4)데이터 생성 주소 : post, 데이터 조회 주소 : get, 데이터 삭제 주소: delete, 데이터 수정 주소 : put
	 */
    ...
    produces = {MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_UTF8_VALUE}
    	- 이 메소드의 리턴값을 xml형태 혹은 json형태로 만들어 주겠다 의 의미
	 */
	...
	public ResponseEntity<Map<String, Object>> getList(@PathVariable("bno") Long bno,
		...
		*/
		...
		ReplyPageDTO replyObj = service.getListPage(cri, bno); //1)댓글목록, 2)본문글을 참조하는 댓글 데이터 개수
		//Service인터페이스의 getListPage()메소드를 사용하기 위해 해당 클래스의 객체 생성
